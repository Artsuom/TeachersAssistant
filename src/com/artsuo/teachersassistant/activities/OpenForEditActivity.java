...
public class OpenForEditActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_openforedit);
		init();
	}
	...
	private void init() {
		...
		this.listSavedFiles = (ListView)findViewById(R.id.openForEditList);
